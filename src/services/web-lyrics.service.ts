...
export class WebLyricsService extends BaseService {
  ...
  constructor(
    ...
    private lyricsCommentRepository: CommentRepository,
    private subLyricsCommentRepository: SubCommentRepository,
    private lyricsLikesRepository: LyricsLikesRepository,
